...
func (in *Phase1ObjStatus) DeepCopyInto(out *Phase1ObjStatus) {
	*out = *in
	...
	if in.ExperimentalConditions != nil {
		in, out := &in.ExperimentalConditions, &out.ExperimentalConditions
...
func (in *Phase2ObjStatus) DeepCopyInto(out *Phase2ObjStatus) {
	*out = *in
	...
	in.BackCompatibility.DeepCopyInto(&out.BackCompatibility)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Phase2ObjStatusBackCompatibility) DeepCopyInto(out *Phase2ObjStatusBackCompatibility) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make(v1beta1.Conditions, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Phase2ObjStatusBackCompatibility.
func (in *Phase2ObjStatusBackCompatibility) DeepCopy() *Phase2ObjStatusBackCompatibility {
	if in == nil {
		return nil
	}
	out := new(Phase2ObjStatusBackCompatibility)
	in.DeepCopyInto(out)
	return out
}
