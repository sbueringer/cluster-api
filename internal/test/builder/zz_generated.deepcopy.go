...
func (in *Phase1ObjStatus) DeepCopyInto(out *Phase1ObjStatus) {
	*out = *in
	...
	in.V1Beta2.DeepCopyInto(&out.V1Beta2)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Phase2ObjStatusDeprecatedV1Beta2) DeepCopyInto(out *Phase2ObjStatusDeprecatedV1Beta2) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make(v1beta1.Conditions, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Phase2ObjStatusDeprecatedV1Beta2.
func (in *Phase2ObjStatusDeprecatedV1Beta2) DeepCopy() *Phase2ObjStatusDeprecatedV1Beta2 {
	if in == nil {
		return nil
	}
