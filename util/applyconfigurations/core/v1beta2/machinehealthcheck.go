...
func ExtractMachineHealthCheckFrom(machineHealthCheck *corev1beta2.MachineHealthCheck, fieldManager string, subresource string) (*MachineHealthCheckApplyConfiguration, error) {
	b := &MachineHealthCheckApplyConfiguration{}
	err := managedfields.ExtractInto(machineHealthCheck, internal.Parser().Type("io.k8s.sigs.cluster-api.api.core.v1beta2.MachineHealthCheck"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractMachineHealthCheck(machineHealthCheck *corev1beta2.MachineHealthCheck, fieldManager string) (*MachineHealthCheckApplyConfiguration, error) {
...
func ExtractMachineHealthCheckStatus(machineHealthCheck *corev1beta2.MachineHealthCheck, fieldManager string) (*MachineHealthCheckApplyConfiguration, error) {
