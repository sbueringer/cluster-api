...
type ControlPlaneTopologyApplyConfiguration struct {
	...
	Rollout *ControlPlaneTopologyRolloutSpecApplyConfiguration `json:"rollout,omitempty"`
...
func (b *ControlPlaneTopologyApplyConfiguration) WithRollout(value *ControlPlaneTopologyRolloutSpecApplyConfiguration) *ControlPlaneTopologyApplyConfiguration {
	b.Rollout = value
	return b
}
...
func (b *ControlPlaneTopologyApplyConfiguration) WithTaints(values ...*MachineTaintApplyConfiguration) *ControlPlaneTopologyApplyConfiguration {
	for i := range values {
		if values[i] == nil {
