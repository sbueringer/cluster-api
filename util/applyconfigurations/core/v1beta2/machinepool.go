...
func ExtractMachinePoolFrom(machinePool *corev1beta2.MachinePool, fieldManager string, subresource string) (*MachinePoolApplyConfiguration, error) {
	b := &MachinePoolApplyConfiguration{}
	err := managedfields.ExtractInto(machinePool, internal.Parser().Type("io.k8s.sigs.cluster-api.api.core.v1beta2.MachinePool"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(machinePool.Name)
	b.WithNamespace(machinePool.Namespace)
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractMachinePool(machinePool *corev1beta2.MachinePool, fieldManager string) (*MachinePoolApplyConfiguration, error) {
...
func ExtractMachinePoolStatus(machinePool *corev1beta2.MachinePool, fieldManager string) (*MachinePoolApplyConfiguration, error) {
