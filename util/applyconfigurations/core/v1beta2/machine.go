...
func ExtractMachineFrom(machine *corev1beta2.Machine, fieldManager string, subresource string) (*MachineApplyConfiguration, error) {
	b := &MachineApplyConfiguration{}
	err := managedfields.ExtractInto(machine, internal.Parser().Type("io.k8s.sigs.cluster-api.api.core.v1beta2.Machine"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractMachine(machine *corev1beta2.Machine, fieldManager string) (*MachineApplyConfiguration, error) {
...
func ExtractMachineStatus(machine *corev1beta2.Machine, fieldManager string) (*MachineApplyConfiguration, error) {
