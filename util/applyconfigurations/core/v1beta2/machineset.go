...
func ExtractMachineSetFrom(machineSet *corev1beta2.MachineSet, fieldManager string, subresource string) (*MachineSetApplyConfiguration, error) {
	b := &MachineSetApplyConfiguration{}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractMachineSet(machineSet *corev1beta2.MachineSet, fieldManager string) (*MachineSetApplyConfiguration, error) {
...
func ExtractMachineSetStatus(machineSet *corev1beta2.MachineSet, fieldManager string) (*MachineSetApplyConfiguration, error) {
