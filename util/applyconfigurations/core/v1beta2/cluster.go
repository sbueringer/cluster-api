...
func ExtractClusterFrom(cluster *corev1beta2.Cluster, fieldManager string, subresource string) (*ClusterApplyConfiguration, error) {
	b := &ClusterApplyConfiguration{}
	err := managedfields.ExtractInto(cluster, internal.Parser().Type("io.k8s.sigs.cluster-api.api.core.v1beta2.Cluster"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(cluster.Name)
	b.WithNamespace(cluster.Namespace)
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractCluster(cluster *corev1beta2.Cluster, fieldManager string) (*ClusterApplyConfiguration, error) {
...
func ExtractClusterStatus(cluster *corev1beta2.Cluster, fieldManager string) (*ClusterApplyConfiguration, error) {
