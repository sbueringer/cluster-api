...
// MachineWithInPlaceCandidateAnnotation returns a machine that has been annotated with the MachineInPlaceUpdateInProgressAnnotation.
func (c *ControlPlane) MachineWithInPlaceCandidateAnnotation(machines collections.Machines) collections.Machines {
...
// getInfraMachines fetches the external infrastructure resource for each machine in the collection and returns a map of machine.Name -> infraResource.
