...
func (in *ClusterClassSpec) DeepCopyInto(out *ClusterClassSpec) {
	*out = *in
	...
	if in.Variables != nil {
		...
		*out = new(VariablesClass)
		(*in).DeepCopyInto(*out)
	}
	if in.Patches != nil {
		in, out := &in.Patches, &out.Patches
		*out = make([]PatchClass, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PatchClass) DeepCopyInto(out *PatchClass) {
	*out = *in
	if in.Definitions != nil {
		in, out := &in.Definitions, &out.Definitions
		*out = make([]variables.PatchDefinitionClass, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PatchClass.
func (in *PatchClass) DeepCopy() *PatchClass {
	if in == nil {
		return nil
	}
	out := new(PatchClass)
...
func (in *Topology) DeepCopyInto(out *Topology) {
	*out = *in
	...
	if in.Variables != nil {
		in, out := &in.Variables, &out.Variables
		*out = make([]variables.VariableTopology, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VariablesClass) DeepCopyInto(out *VariablesClass) {
	*out = *in
	if in.Definitions != nil {
		in, out := &in.Definitions, &out.Definitions
		*out = make([]variables.VariableDefinitionClass, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VariablesClass.
func (in *VariablesClass) DeepCopy() *VariablesClass {
	if in == nil {
		return nil
	}
	out := new(VariablesClass)
