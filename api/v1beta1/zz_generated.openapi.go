		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"classNamespace": {
						SchemaProps: spec.SchemaProps{
							Description: "The namespace of the ClusterClass object to create the topology. If the namespace is empty or not set, it is defaulted to the namespace of the cluster object. Value must follow the DNS1123Subdomain syntax.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
